...
@click.option('--derechos/--no-derechos', default=False)
@click.option("--reducir-cups/--no-reducir-cups",default=False)
@click.option('--prefix_at', help="Prefix dels Trams AT", default='A')
...
@click.option('-d', '--database', help='Nom de la base de dades')
@click.option('--num-proc', default=N_PROC, type=click.INT)
@click.option('--elements-baixa/--no-elements-baixa', default=True, help="Afegir elements donats de baixa")
def cir_8_2021_fb2(**kwargs):
    ...
    proc = cir_8_2021.FB2(
        ...
        codi_r1=kwargs['codi_r1'],
        year=kwargs['year'],
        elements_baixa=kwargs['elements_baixa']
    )
    proc.calc()
